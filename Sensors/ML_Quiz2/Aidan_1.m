...
principal_point = [658, 508]; % Assuming the principal point is in the center of the image
focal_length = 900; % Focal length for both cameras

% Relative pose
translation_T = [0.18; 0; 0]; % Translation from right to left camera

left_image_point = [320, 508]; % (x, y) in the left image
right_image_point = [180, 508]; % (x, y) in the right image
